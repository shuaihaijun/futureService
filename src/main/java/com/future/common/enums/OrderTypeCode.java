...
public enum OrderTypeCode implements ResultCode {
    /*  */
    ORDER_TYPE_BUY(0, "BUY"),
    ORDER_TYPE_SELL(1, "SELL"),
    ORDER_TYPE_BUYLIMIT(2, "BUYLIMIT"),
    ORDER_TYPE_SELLLIMIT(3, "SELLLIMIT"),
    ORDER_TYPE_BUYSTOP(4, "BUYSTOP"),
    ORDER_TYPE_SELLSTOP(5, "SELLSTOP"),
    ORDER_TYPE_DEPOSIT(6, "DEPOSIT"),
    ORDER_TYPE_CREDIT(7, "CREDIT"),
